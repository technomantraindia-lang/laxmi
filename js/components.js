...
(function () {
  ...
  var HEADER_HTML = '<header class="site-header" id="site-header">' +
    ...
    '<div class="drawer-sub-pane" id="sub-pane-solutions"><button type="button" class="drawer-mobile-back-btn" data-back-level="1"><span>←</span> <span>Main Menu</span></button><h3 class="sub-pane-title"><a href="raw-materials.html">Start Your AAC Journey</a></h3><ul class="col2-menu-list"><li class="col2-item" data-tertiary="sol-raw-materials"><a href="raw-materials.html" class="col2-link"><strong>Raw Materials</strong></a></li></ul></div>' +
  ...
  function highlightActivePage() {
    ...
    var solutionsPages = ['raw-materials.html'];
